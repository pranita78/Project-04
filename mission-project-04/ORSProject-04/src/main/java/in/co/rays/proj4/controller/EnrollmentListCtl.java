...
public class EnrollmentListCtl extends BaseCtl {
    ...
    Logger log = Logger.getLogger(EnrollmentListCtl.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<EnrollmentBean> list = model.search(bean, pageNo, pageSize);
            List<EnrollmentBean> next = model.search(bean, pageNo + 1, pageSize);
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    EnrollmentBean deleteBean = new EnrollmentBean();
                    ...
                    ServletUtility.setSuccessMessage("Enrollment deleted successfully", request);
