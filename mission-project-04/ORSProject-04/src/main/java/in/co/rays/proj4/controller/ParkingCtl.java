...
public class ParkingCtl extends BaseCtl {
    ...
    Logger log = Logger.getLogger(ParkingCtl.class);
    ...
    protected BaseBean populateBean(HttpServletRequest request) {
        ...
        bean.setParkingId(DataUtility.getLong(request.getParameter("id")));
        bean.setLocation(DataUtility.getString(request.getParameter("location")));
        bean.setCapacity(DataUtility.getInt(request.getParameter("capacity")));
        bean.setFee(DataUtility.getDouble(request.getParameter("fee")));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id > 0) {
            ...
            bean = new ParkingBean();   // 👈 yaha bean create kiya
        }

        ServletUtility.setBean(bean, request);  // 👈 yaha set kiya (bahar)
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (OP_SAVE.equalsIgnoreCase(op)) {
            ...
            try {
                ...
                ServletUtility.setBean(bean, request);
                ServletUtility.setErrorMessage("Parking already exists", request);
