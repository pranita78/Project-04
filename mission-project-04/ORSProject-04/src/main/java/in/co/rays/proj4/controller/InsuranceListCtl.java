...
public class InsuranceListCtl extends BaseCtl {
	...
	Logger log = Logger.getLogger(InsuranceListCtl.class);
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op)
				...
				if (ids != null && ids.length > 0) {
					...
					for (String id : ids) {
						...
						deletebean.setInsuranceId(DataUtility.getLong(id));

						model.delete(deletebean.getInsuranceId());

						ServletUtility.setSuccessMessage("Insurance deleted successfully", request);
					}
