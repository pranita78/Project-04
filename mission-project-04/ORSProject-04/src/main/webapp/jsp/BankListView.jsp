    ...
    <div align="center">
        ...
        <form action="<%=ORSView.BANK_LIST_CTL%>" method="post">
            ...
            <%
                ...
                List<BankBean> list =
                        (List<BankBean>) ServletUtility.getList(request);
            ...
            <table border="1" style="width: 100%; border: groove;">
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><%=bean.getBranchName()%></td>
                    <td style="text-align: center;"><%=bean.getAccountHolderName()%></td>
                    <td style="text-align: center;"><%=bean.getMobileNo()%></td>

                    <td style="text-align: center;">
                        <a href="BankCtl?id=<%=bean.getId()%>">Edit</a>
                    </td>
                </tr>
